...
class Ui_EducationGridGUIInstaller(object):
    def setupUi(self, EducationGridGUIInstaller):
        ...
        EducationGridGUIInstaller.resize(220, 210)
        ...
        self.label_3 = QtGui.QLabel(EducationGridGUIInstaller)
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(False)
    ...
    def retranslateUi(self, EducationGridGUIInstaller):
        ...
        self.label_3.setText(_translate("EducationGridGUIInstaller", "Run with Administrative Privileges", None))
